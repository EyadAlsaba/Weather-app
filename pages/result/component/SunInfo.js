...
export default function SunInfo({ props }) {
  return (
    //sec: relative top-1/3 md:mt-40 py-2 | relative md:bottom-20 md:ml-10 md:mt-5
    ...
    <section className="">
      <div className="flex">
        ...
        <div className="lg:w-20 lg:h-20 lg:text-lg md:w-16 md:h-16 md:text-sm rounded-full flex flex-col justify-center items-center text-white bg-blackBG ml-1">
          <IconContext.Provider value={{ size: '1.5rem' }}>
            <WiHorizon />
          </IconContext.Provider>
          <p>{props.sunset}</p>
